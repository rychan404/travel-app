...
export const AboutContainer = () => {
    return (
        <div className='flex justify-between h-[70vh] bg-gradient-to-r from-sky-100 from-10% via-teal-100 via-30% to-emerald-100 to-90%'>
            <div className='p-20'>
                <h1 className='text-6xl font-[Roboto] font-bold text-stone-800'>About Us</h1>
